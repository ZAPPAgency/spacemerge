...
// Manual taps are bursty: the displayed rate averages them over this window
const MANUAL_TAP_RATE_WINDOW_MS = 3000;
...
const TIERS = [
  ...
  },
  {
    ...
    name: "Géante gazeuse",
    emoji: "🪐",
    icon: "tier-5-geante-gazeuse.png",
    from: "#f6d365",
    to: "#b8722e",
  },
  {
  ...
  },
  {
    ...
    emoji: "💫",
    icon: "tier-7-etoile-neutrons.png",
    from: "#0e3d45",
    to: "#020a0c",
    iconScale: 1.3,
  },
...
const EMOJI_SETS = [
  ...
  // `icon`, `iconScale`: same fields as TIERS, per tierSkin entry.
  {
    ...
    tierSkin: [
      ...
      {
        emoji: "🍑",
        name: "Pêche Stellaire",
        icon: "fruit-12-peche.png",
        iconScale: 1.15,
      },
  ...
  },
  {
    ...
    tierSkin: [
      ...
      { emoji: "🫛", name: "Petit Pois", icon: "legume-8-pois.png" },
      {
        ...
        icon: "legume-9-citrouille.png",
      },
      { emoji: "🌻", name: "Fleur Cosmique", icon: "legume-10-fleur.png" },
      {
        emoji: "🥒",
        name: "Concombre Cosmique",
        icon: "legume-11-concombre.png",
      },
      {
        emoji: "🧄",
        name: "Ail Stellaire",
        icon: "legume-12-ail.png",
        iconScale: 1.15,
      },
...
const SKILL_TREE = {
  prod: {
    name: "Production Stellaire",
    desc: "+3% production globale / niveau",
    maxLevel: 50,
    base: 1,
    growth: 1.25,
  },
  swarm: {
    name: "Essaim",
    desc: "+1 case de départ déverrouillée / niveau",
    maxLevel: 10,
    base: 2,
    growth: 1.4,
  },
  gravity: {
    name: "Gravité Rapide",
    desc: "-5% cooldown de spawn auto / niveau (plancher 3s)",
    maxLevel: 8,
    base: 1,
    growth: 1.3,
  },
  echo: {
    name: "Écho Temporel",
    desc: "+2h de plafond hors-ligne / niveau (max 24h)",
    maxLevel: 8,
    base: 2,
    growth: 1.35,
  },
  luck: {
    name: "Chance Cosmique",
    desc: "+1% chance de Gem bonus par fusion / niveau",
    maxLevel: 20,
    base: 1,
    growth: 1.2,
  },
...
const RUN_UPGRADE_TREE = {
  catalyst: {
    name: "Catalyseur Stellaire",
    desc: "+4% production de Stardust de chaque case / niveau",
    maxLevel: 15,
    base: 3000,
    growth: 1.5,
    first: 300,
  ...
  resonance: {
    name: "Résonance des Cases",
    desc: "+3% de chance de débloquer une case supplémentaire gratuite à chaque déblocage / niveau",
    maxLevel: 10,
    base: 5000,
    growth: 1.5,
    first: 500,
  ...
  surge: {
    name: "Surcharge du Big Bang",
    desc: "+5% d'Énergie Cosmique gagnée au prochain Big Bang / niveau",
    maxLevel: 10,
    base: 8000,
    growth: 1.55,
    first: 800,
  ...
  cadence: {
    name: "Cadence Stellaire",
    desc: "-4% cooldown de spawn auto / niveau (plancher 3s, cumulable avec Gravité Rapide)",
    maxLevel: 8,
    base: 6000,
    growth: 1.55,
    first: 600,
...
const GODS = [
  ...
  // benevolent and a fallen god side by side.
  {
    id: "zephar",
    name: "Zéphar",
    title: "Seigneur des Lunes Brisées",
    emoji: "🌘",
    icon: "zephar.png",
    rarity: "commun",
    alignment: "dechu",
    ...
    effects: {
      gemChanceBonus: 0.15,
      tierProdBonus: { minTier: 2, maxTier: 3, mult: 0.92 },
    },
  ...
  },
  {
    ...
    unlock: {
      type: "milestone",
      check: (s) => s.lifetime.fusions >= 180,
      label: "Réalise 180 fusions à vie",
    },
  ...
  },
  {
    ...
    unlock: {
      type: "milestone",
      check: (s) => s.achievements.unlockedIds.includes("unlocked_20"),
      label: "Débloque 20 cases en une partie",
    },
  ...
  },
  {
    ...
    unlock: {
      type: "milestone",
      check: (s) => s.lifetime.maxTierEver >= 7,
      label: "Atteins le palier Étoile à neutrons",
    },
  ...
  },
  {
    ...
    unlock: {
      type: "milestone",
      check: (s) => s.lifetime.bigBangCount >= 3,
      label: "Déclenche 3 Big Bang",
    },
  ...
  },
  {
    ...
    unlock: {
      ...
      challengeId: "erebus",
      label:
        "Défi : fusionne 35 fois d'affilée sans jamais appuyer sur une case pour récupérer son bonus (appuyer remet ce compteur à zéro)",
      target: 35,
    },
  ...
  },
  {
    ...
    unlock: {
      type: "challenge",
      challengeId: "thanatos",
      label:
        "Défi : déclenche un Big Bang alors que moins de la moitié des cases débloquées sont occupées",
      target: 1,
    },
  ...
  },
  {
    ...
    unlock: {
      type: "shop",
      cost: 800,
      altCheck: (s) => s.lifetime.bigBangCount >= 10,
      altLabel: "ou 10 Big Bang déclenchés",
    },
  ...
  },
  {
    ...
    unlock: {
      type: "shop",
      cost: 800,
      altCheck: (s) => s.gods.morgorathChallengeCleared,
      altLabel:
        "ou atteins l'Univers sans utiliser Sauter une case ni Échanger deux cases dans la partie",
    },
...
const EASTER_EGGS = [
  {
    ...
    revealText:
      "Tu as tout recommencé alors que l'infini t'attendait déjà. Certains préfèrent choisir leur propre chemin.",
  },
  {
    id: "pure_extremes",
    name: "Les Extrêmes",
    ...
    revealText:
      "Un Big Bang né d'une grille faite uniquement de commencements et d'un seul aboutissement.",
  },
  {
    id: "merge_chain",
    name: "La Cascade",
    ...
    revealText:
      "Dix fusions en une poignée de secondes. Le Cosmos a du mal à suivre.",
  },
  {
    id: "second_loop",
    ...
    revealText:
      "Une deuxième boucle s'est refermée sur elle-même. Le cycle n'a pas de fin.",
  },
];
...
const DAILY_REWARDS = [
  ...
  { day: 6, type: "streakFreeze", amount: 1, label: "❄️ Gel de série" },
  {
    ...
    type: "bigReward",
    amount: 1,
    label: "1 ⚡ Énergie Cosmique + gros lot ✨",
  },
];
...
const QUEST_POOL = [
  ...
  {
    id: "reachPlanet",
    desc: "Atteins le palier Planète",
    type: "reachTier",
    target: 4,
    reward: 6,
  },
  {
    id: "reachBlackHole",
    desc: "Atteins le palier Trou noir",
    type: "reachTier",
    target: 8,
    reward: 14,
  },
  ...
  {
    id: "tapBonus10",
    desc: "Récupère 10 bonus manuels",
    type: "tapBonuses",
    target: 10,
    reward: 6,
  },
  {
    id: "spawnAuto5",
    desc: "Laisse apparaître 5 Météorites automatiques",
    type: "autoSpawns",
    target: 5,
    reward: 4,
  },
  {
    id: "fuse5tier5",
    desc: "Fusionne jusqu'à Géante gazeuse",
    type: "reachTier",
    target: 5,
    reward: 8,
  },
  ...
  {
    id: "reachGalaxy",
    desc: "Atteins le palier Galaxie",
    type: "reachTier",
    target: 9,
    reward: 18,
  },
  {
    id: "reachNeutronStar",
    desc: "Atteins le palier Étoile à neutrons",
    type: "reachTier",
    target: 7,
    reward: 12,
  },
  ...
  {
    id: "tapBonus20",
    desc: "Récupère 20 bonus manuels",
    type: "tapBonuses",
    target: 20,
    reward: 10,
  },
  ...
  {
    id: "spawnAuto10",
    desc: "Laisse apparaître 10 Météorites automatiques",
    type: "autoSpawns",
    target: 10,
    reward: 7,
  },
];
const BONUS_AD_QUEST = {
  id: "watchAd",
  desc: "Regarde une publicité",
  reward: 25,
};
...
const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    cat: "bigBangs",
    target: 20,
    name: "Éternel recommencement",
    reward: 100,
  },
  {
    id: "lifetime_10k",
    cat: "lifetimeStardust",
    target: 10000,
  ...
  },
  {
    ...
    cat: "lifetimeStardust",
    target: 100000,
    name: "Riche en poussière d'étoiles",
    reward: 15,
  },
  {
    id: "lifetime_1m",
...
const SHOP_GEM_ITEMS = [
  {
    id: "skipCell",
    name: "Sauter une case",
    desc: "Débloque instantanément une case verrouillée",
    cost: 25,
  },
  {
    id: "swapCells",
    name: "Échanger deux cases",
    desc: "Permute le contenu de deux cases au choix",
    cost: 50,
  },
  {
    id: "streakFreeze",
    name: "Gel de série",
    desc: "Protège ta série de connexion pendant 1 jour manqué",
    cost: 20,
  },
  ...
  // with BOX_RARITY_WEIGHTS below by hand if those ever change.
  {
    id: "cosmicBox",
    name: "Boîte Cosmique",
    desc: "Un Dieu que tu ne possèdes pas encore - Commun 50% · Rare 30% · Épique 15% · Légendaire 5% (jusqu'à 200 Gems une fois tous les Dieux obtenus)",
    cost: 120,
  },
];
...
const IAP_CATALOG = [
  {
    id: "remove_ads",
    type: "nonconsumable",
    name: "Suppression des pubs",
    price: "4,99 $",
    desc: "Retire toutes les publicités définitivement, et débloque instantanément tous les bonus normalement obtenus en pub (boost, quête bonus).",
  },
  ...
  },
  {
    id: "stardust_boost",
    type: "nonconsumable",
    name: "Multiplicateur Stardust",
    price: "2,99 $",
    desc: "+50% de production de Stardust, en permanence, cumulable avec tous les autres bonus.",
  },
  {
    id: "starter_pack",
    type: "nonconsumable",
    ...
    price: "1,99 $",
    desc: "500 Gems + 3 cases + boost 1h.",
    startersOnly: true,
  },
  {
    id: "gems_small",
...
function unlockCost(n) {
  return Math.round(50 * Math.pow(1.8, n));
}
...
function bigBangTileWeight(tier) {
  ...
  return (
    Math.round(13 * Math.pow(1.4, escalating - UNIVERSE_TIER)) +
    looped * BIG_BANG_LOOP_TIER_BONUS
  );
}
...
function godPowerCost(nextLevel) {
  return Math.ceil(15 * Math.pow(1.35, nextLevel - 1));
}
